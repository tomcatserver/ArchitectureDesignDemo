...
import com.example.network.secure.Charsets;
import com.example.network.secure.Hex;
...
public final class DigestUtil {
    ...
    public static byte[] md5Digest(String data) {
        return md5Digest(data.getBytes(Charsets.UTF_8));
    }
    ...
    public static String md5Hex(byte[] data) {
        return Hex.encodeHex(md5Digest(data));
    }
    ...
    public static byte[] sha(String data) {
        return sha(data.getBytes(Charsets.UTF_8));
    }
    ...
    public static String hmacSHA1(String base, String key) {
        try {
            ...
            if (key != null) {
                SecretKeySpec spec = new SecretKeySpec(key.getBytes(Charsets.UTF_8), HMAC_SHA1);
                mac.init(spec);
            }

            byte[] bytes = mac.doFinal(base.getBytes(Charsets.UTF_8));
