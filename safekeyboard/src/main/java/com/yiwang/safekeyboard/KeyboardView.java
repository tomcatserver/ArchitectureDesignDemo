...
import com.yiwang.safekeyboard.Keyboard.Key;
...
import static com.yiwang.safekeyboard.Constants.PLACEHOLDER_KEY_BOARD;
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.KeyboardView_keyBackground) {
                ...
                mKeyTextColor = a.getColor(attr, Color.BLACK);
...
//        a = getContext().obtainStyledAttributes(com.android.internal.R.styleable.Theme);
//        mBackgroundDimAmount = a.getFloat(android.R.styleable.Theme_backgroundDimAmount, 0.5f);
        ...
        mDisambiguateSwipe = getResources().getBoolean(
                Resources.getSystem().getIdentifier("config_swipeDisambiguation", "bool", "android"));
...
//        mAccessibilityManager = AccessibilityManager.getInstance(context);
    ...
    protected void drawNormalKey(Canvas canvas, Keyboard.Key key) {
    }


    protected void drawSpecialKey(Canvas canvas, Keyboard.Key key, Paint paint) {
    }
    ...
    private void onBufferDraw() {
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            if (key.codes[0] == Constants.DELETE_KEY_BOARD || key.codes[0] == Constants.LETTER_KEY_BOARD || key.codes[0] == Constants.SPECIAL_CHARACTERS_KEY_BOARD || key.codes[0] == LETTER_SWITCH_KEY_BOARD || key.codes[0] == NUMBER_DELETE_KEY_BOARD) {
                drawSpecialKey(canvas, key, mPaint);
            } else {
                if (key.codes[0] != PLACEHOLDER_KEY_BOARD) {
